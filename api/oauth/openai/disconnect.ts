// api/oauth/openai/disconnect.ts — Remove ChatGPT OAuth credentials
// POST /api/oauth/openai/disconnect (admin only) — POST used instead of DELETE for form compat
